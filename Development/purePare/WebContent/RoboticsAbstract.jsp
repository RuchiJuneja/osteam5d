			...
			<div id="content_right">
				...
				<div style="font-size: 20px; color: #4895c8;">
					<s:url action="getpdf.action" var="Link">
						<s:param name="id">pdf/robotics/ieee1.pdf</s:param>
					</s:url>
				...
				<div style="font-size: 20px; color: #4895c8;">
					<s:url action="getpdf.action" var="Link">
						<s:param name="id">pdf/robotics/ieee2.pdf</s:param>
					</s:url>
					<a href="<s:property value="#Link"/>"><span></span>IEEE
				...
				<div style="font-size: 20px; color: #4895c8;">
					<s:url action="getpdf.action" var="Link">
						<s:param name="id">pdf/robotics/iet.pdf</s:param>
					</s:url>
					<a href="<s:property value="#Link"/>"><span></span>Piezomagnetic
						control of machines</a>
				</div>

				<br />
				<div style="font-size: 16px; color: #4895c8;">Abstract</div>
				<p class="news">Modern magnetic materials, particularly in thin
					film or multilayer form, offer piezomagnetic properties that have
					the potential to compete with piezoelectric materials in devices.
					This paper offers an overview of these new materials and their
					properties, gives a discussion of the potential benefits to be
					derived from using them, and gives an illustrative example of
					application in a device</p>
				<br />
				<div style="font-size: 16px; color: #4895c8;">Publication</div>
				<p class="news">IET</p>
				...
				<div style="font-size: 20px; color: #4895c8;">
					<s:url action="getpdf.action" var="Link">
						<s:param name="id">pdf/robotics/vde.pdf</s:param>
					</s:url>
					<a href="<s:property value="#Link"/>"><span></span>Speaker
						tracking for teleconference via binuaral headset microphone</a>
				</div>
				<br />
				<div style="font-size: 16px; color: #4895c8;">Abstract</div>
