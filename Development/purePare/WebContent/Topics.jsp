...
<div class="content_header_01">Topics</div>     
            
            
            
<ul class="news">
                
<li><a href="<s:url value="/AerospaceAbstract.jsp" />"><span></span>Aerospace</a></li>
                
<li><a href="<s:url value="/CNBAbstract.jsp" />"><span></span>Communication , networking and broadcasting</a></li>
                
<li><a href="<s:url value="/GeoscienceAbstract.jsp" />"><span></span>Geoscience</a></li>
    
<li><a href="<s:url value="/RoboticsAbstract.jsp" />"><span></span>Robotics and control systems</a></li>
            
<li><a href="<s:url value="/SignalsAbstract.jsp" />"><span></span>Signal processing and analysis</a></li>

<li><a href="<s:url value="/ComputingAbstract.jsp" />"><span></span>Computing and processing</a></li>            
</ul>
