...
public class MyLogAction {
	...
	public static void myCatch(String reportType, String programName,
		...
		ReporterAction reporter = ReporterAction.get("catch");
	...
	public static void myWrite(String reportType, String message) {
		...
		ReporterAction reporter = ReporterAction.get(reportType);
	...
	public static void printLine(String text, PrintWriter out) {
		...
		textPrint += text;
		AU1Action.reportMessage(out, textPrint, 1);
		out.flush();
		return;
	}
