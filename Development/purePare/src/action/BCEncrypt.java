...
public class BCEncrypt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputStream pubKey = new FileInputStream("/home/ranadheer/Downloads/OS/keys/igolderpublic.txt");
        byte[] encrypted = encrypt(original, readPublicKey(pubKey), null,
                true, true);

        FileOutputStream dfis = new FileOutputStream("/home/ranadheer/Downloads/OS/keys/enc.txt");
        dfis.write(encrypted);
        dfis.close();

        byte[] encFromFile = getBytesFromFile(new File("/home/ranadheer/Downloads/OS/keys/enc.txt"));
        FileInputStream secKey = new FileInputStream("/home/ranadheer/Downloads/OS/keys/igolderprivate.txt");
